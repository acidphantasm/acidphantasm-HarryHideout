...
class SampleTrader implements IPreAkiLoadMod, IPostDBLoadMod
{
    ...
    public postDBLoad(container: DependencyContainer): void
    {
        ...
        // Add nuts
        const SCREWS_ID = "59e35ef086f7741777737012"; // Can find item ids in `database\templates\items.json` or with https://db.sp-tarkov.com/search
        this.fluentAssortCreator.createSingleAssortItem(SCREWS_ID)
                                    .addStackCount(20)
        ...
        this.fluentAssortCreator.createSingleAssortItem(NUTS_ID)
                                    ...
                                    .addLoyaltyLevel(1)
                                    .export(tables.traders[baseJson._id]);
        // Add 2x bitcoin as barter for LEDX
